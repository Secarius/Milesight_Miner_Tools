...
try:
    ...
    f.write("#MinerName,IP,User,Password,Port\nTestminer,192.168.1.123,root,LoRaWAN@2018,22")
    f.close
finally:
    f.close()
minerconfig = genfromtxt(os.path.abspath(optionspath), comments="#", delimiter=",", dtype='unicode')
...
# Button Actions
        ...
        self.button_config_reload.clicked.connect(self.safe_config)
...
#        self.button_send_command.clicked.connect(self.run_funk)
    ...
    def get_url_paths(self):
        ...
        try:
            self.update_fbdata('Not working on mac os\n')
            reply = QtWidgets.QMessageBox.question(self, 'Message',
                "Only working on Windows", QtWidgets.QMessageBox.Ok)
    ...
    def edit_config(self):
        ...
        self.clear_fbdata()
        with open(optionspath, "r") as f1:
                for line in f1:
                    self.update_fbdata(line)
        f1.close()
        self.updatecombo()

    def safe_config(self):
        #os.system('notepad.exe ' + optionspath)
        with open(optionspath, 'w') as yourFile:
            yourFile.write(str(self.text_console.toPlainText()))
            yourFile.close()
        self.updatecombo()
        self.clear_fbdata()
        self.update_fbdata('Config saved!\n')
        self.update_fbdata('Please restart Programm\n')
        self.updatecombo()
...
##################################################################
    def retranslateUi(self, MainWindow):
        ...
        self.button_config_reload.setText(_translate("MainWindow", "Safe Config"))
